...
<nav class="bg-navbar"> 
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ">
        <li>
            <NuxtLink to="/"
            class="block py-2 px-3 rounded-sm md:bg-transparent text-navbar-text hover:text-navbar-hover  md:p-0">
            Job Finder
            </NuxtLink>
        </li>
        <li>
    ...
    <button @click="toggleTheme" type="button" class="focus:outline-none focus:ring-4 rounded-lg text-sm p-2.5">
